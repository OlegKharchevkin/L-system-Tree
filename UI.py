class UI:
    ...
    def reset(self):
        self.turtle.clear()
        self.turtle.penup()
        self.turtle.setposition(0,-self.h/2+self.h/9)
        self.turtle.seth(90)
        self.turtle.pendown()
    def num_of_itr(self,i):
        self.turtle.penup()
        self.turtle.setpos(-(self.w/2)+(self.w/16),(self.h/2)-(self.h/9))
        self.turtle.write(i,font=("Arial", int(self.h/45), "normal"))
        self.turtle.setposition(0,-self.h/2+self.h/9)
        self.turtle.seth(90)
        self.turtle.pendown()
    def goodbye_msg(self):
        ...
        self.turtle.write("Click on screen to exit",font=("Arial", int(self.h/45), "normal"))
    def fullscreen(self):
